    ...
    <Card className="w-full relative overflow-hidden bg-card border-border">
      <CardHeader className="pb-4 relative">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <CardTitle className="text-lg md:text-xl font-extrabold tracking-tight text-foreground">
      ...
      <CardContent className="space-y-4 relative">
        <div className="grid grid-cols-4 gap-2 md:gap-3 text-center">
          <div className="bg-muted/70 rounded-lg shadow-inner p-0.5">
            <div className="relative h-full w-full bg-background rounded-[inherit] py-3 md:py-4">
              <span className="block text-3xl md:text-4xl font-black text-foreground tracking-tighter tabular-nums">{days}</span>
          ...
          <div className="bg-muted/70 rounded-lg shadow-inner p-0.5">
            <div className="relative h-full w-full bg-background rounded-[inherit] py-3 md:py-4">
              <span className="block text-3xl md:text-4xl font-black text-foreground tracking-tighter tabular-nums">{hours}</span>
          ...
          <div className="bg-muted/70 rounded-lg shadow-inner p-0.5">
            <div className="relative h-full w-full bg-background rounded-[inherit] py-3 md:py-4">
              <span className="block text-3xl md:text-4xl font-black text-foreground tracking-tighter tabular-nums">{minutes}</span>
        ...
        <div className="flex items-center justify-center gap-2 rounded-lg border border-border bg-muted/40 px-3 py-2.5 text-muted-foreground min-h-[36px]">
          {mounted ? (
            <>
