...
export const helpFaqItems = helpFaqSections.flatMap((section) => section.items)
...
export function searchHelpFaqs(query: string, limit = 5) {
  return searchFaqItems(query, helpFaqItems, limit)
}
