        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-8 pt-8">
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <div className="flex gap-3">
                <span className="text-primary font-bold min-w-fit">🗳️ Abstimmungen</span>
          ...
          <section>
            <h3 className="text-lg font-semibold text-foreground border-l-4 border-primary pl-3 mb-4">🏗️ Technische Architektur</h3>
          ...
          <section>
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                <strong>Built with:</strong> Next.js, Firebase, TypeScript, Tailwind CSS, shadcn/ui & viel ☕
              </p>
