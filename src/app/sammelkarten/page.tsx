...
export default function SammelkartenPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <Tabs defaultValue="sammelkarten" className="w-full">
        <div className="flex justify-center mb-8">
          <TabsList className="grid w-full max-w-[400px] grid-cols-2">
            <TabsTrigger value="sammelkarten" className="flex items-center gap-2">
              <Gift className="h-4 w-4" /> Sammelkarten
            </TabsTrigger>
            <TabsTrigger value="album" className="flex items-center gap-2">
              <Trophy className="h-4 w-4" /> Album
            </TabsTrigger>
          </TabsList>
        </div>

        <TabsContent value="sammelkarten">
